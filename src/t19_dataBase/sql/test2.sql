...
/* ddl*/
create table test(  
	idx int not null auto_increment primary key,  /*인덱스번호 고유번호 데이터베이스는 1번부터 시작 오토인크리먼트 숫자 자동증가 그래서 내가 실수를 안함 시퀀스 중간에 지워져도 안채우고 늘어남 */
...
desc test;/*생성된 테이블의 구조 보기 x로만 실행됨 이유를 모름*/
...
insert into test values (default,'아톰', 10,'남자','서울'); 
insert into test values (default,'강감찬', 20,'여자','광주'); 
insert into test values (default,'이사랑', 5,'여자','대구'); 
insert into test values (default,'강수연', 70,'여자','청주'); 
insert into test values (default,'고릴라', 56,'남자','청주'); 
insert into test values (default,'김감자', 100,'남자','조치원'); 
insert into test values (default,'이자바', 9999,'여자','청주'); 
insert into test values (default,'오로지', 40,'여자','청주'); 
insert into test values (default,'김자월', 30,'여자','제주'); 
insert into test values (default,'오자월', 22,'여자','제주'); 
insert into test values (default,'오이자월', 29,'여자','청주'); 
insert into test values (default,'김자월하', 36,'여자','청주'); 
